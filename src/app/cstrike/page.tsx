...
export default function GamePage() {
        ...
        if (iframeRef.current) {
            ...
            if (!document.fullscreenElement) {
                iframe.requestFullscreen().catch((error) => {
                    console.error(
                        "Error attempting to enter fullscreen:",
                        error,
                    );
                });
            } else {
    ...
    const gameUrl = "https://phantomsummon.com/games/2024/unity2/fps-strike/pre.html"; // The URL you want to proxy and load inside the iframe
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 flex flex-col items-center">
                ...
                <div className="mt-8 w-full max-w-4xl bg-white/5 backdrop-blur-md rounded-lg p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                        series of multiplayer tactical first-person shooter
                        video games in which teams of terrorists battle to
                        perpetrate an act of terror.
                    </p>
                    <div className="flex justify-between items-center">
                        <div>
