        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 flex flex-col items-center">
                ...
                <div className="relative bg-black rounded-lg overflow-hidden shadow-2xl w-full max-w-4xl aspect-video">
                    <iframe
                        ref={iframeRef}
                        src="https://html5.gamedistribution.com/44d7c05ce7794f71a96aaa810da0dd06/" // Replace with actual game URL
                ...
                <div className="mt-8 w-full max-w-4xl bg-white/5 backdrop-blur-md rounded-lg p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                        a single-player card game where the goal is to arrange all the cards into four foundation piles, in order from ace to king by suit
                    </p>
                    <div className="flex justify-between items-center">
                        <div>
                            <span className="text-purple-400 font-semibold">Genre:</span> Solitaire
                        </div>
